...
Hockey Insight is a web application that provides advanced NHL analytics using ELO ratings, predictive modeling, and real-time game data. It is designed to help users better understand team performance, player trends, and game outcomes through data-driven insights.
...
The platform is intended for both casual fans and more advanced users who want to explore the data behind the game and make more informed evaluations.

# Purpose

The goal of Hockey Insight is to make advanced hockey analytics more accessible by presenting complex models and data in a clear, user-friendly interface.